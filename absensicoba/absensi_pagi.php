...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <!-- Form -->
            <form id="absensiForm" action="proses_absensi.php" method="post" class="form">
                ...
                <input type="hidden" name="jenis_absensi" value="Pagi">
                <button type="submit" class="btn-submit" onclick="showNotification(event)">Absensi Pagi</button>
            </form>
        </div>
    </div>
</body>
