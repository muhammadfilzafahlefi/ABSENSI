    ...
    <div class="content">
        ...
        <div class="main-content">
            ...
            <table border="1" cellspacing="0" cellpadding="10">
                ...
                <tbody>
                    ...
                    if (isset($_POST['update_waktu'])) {
                        ...
                        $update_sql = "UPDATE absensi_pagi SET waktu='$waktu' WHERE id='$id'";
                    ...
                    $sql = "SELECT id, nip, nama, golongan, jabatan, waktu FROM absensi_pagi";
            ...
            if (isset($_GET['edit_id'])) {
                ...
                $sql = "SELECT * FROM absensi_pagi WHERE id = '$edit_id'";
                $result = $conn->query($sql);
                $row = $result->fetch_assoc();
                ?>

                <h3>Edit Waktu</h3>
                <form method="POST" action="setting_pagi.php">
